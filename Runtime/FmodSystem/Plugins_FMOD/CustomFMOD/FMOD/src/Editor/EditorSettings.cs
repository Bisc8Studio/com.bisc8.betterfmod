...
namespace FMODUnity
{
    ...
    public class EditorSettings : IEditorSettings
    {
        ...
        private static string FMODFolderFull => RuntimeUtils.PluginInstallPath;

        private const string CacheFolderName = "Cache";
        private static string CacheFolderRelative => $"{RuntimeUtils.PluginInstallPath}/{CacheFolderName}";
        ...
        public void CreateSettingsAsset(string assetName)
        {
            ...
            if (inPackagesFolder)
            {
                resourcesPath = "Assets/BISC8/BetterFMOD/FMOD/Resources";
            }
